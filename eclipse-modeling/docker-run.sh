...
IMG_NAME=wagnermarques/fzl_eclipse-modeling:0.0.1;

CONTAINER_NAME=fzl_eclipse-modeling;
CONTAINER_IP=192.168.33.169
...
docker run \
       --name $CONTAINER_NAME -d -p 5905:5901 \
...
echo Container ports:  5905:5901
