#!/bin/bash
#http://blog.sonatype.com/2011/01/downloading-artifacts-from-nexus-with-bash/
#https://support.sonatype.com/hc/en-us/articles/213465818-How-can-I-programmatically-upload-an-artifact-into-Nexus-
# Argument = -h -v -i groupId:artifactId:version -c classifier -p packaging -r repository

#shopt -o -s xtrace

# Define Nexus Configuration
NEXUS_BASE=localhost:8081/repository/maven-public/
