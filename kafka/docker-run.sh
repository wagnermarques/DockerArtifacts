...
mkdir -p $(pwd)/../kafka-containers-shared-dir/$CONTAINER_NAME #dir for each liferay containers shared folders
SHARED_FOLDER=$(pwd)/../kafka-containers-shared-dir/$CONTAINER_NAME
